...
// ============================================================
// CREATE ORDER (PRODUCTION GRADE WITH OFFERS)
// ============================================================
  ...
  try {
    ...
    try {
      ...
      for (const item of sortedItems) {
        ...
        backendCalculatedSubtotal += Number(product.price) * qty;
      ...
      if (finalSecureTotal < 1 && finalSecureTotal !== 0) {
        await t.rollback();
      ...
      const order = await Order.create({
        userId,
        totalAmount: backendCalculatedSubtotal, 
        orderAmount: finalSecureTotal, 
      ...
      const payload = {
        ...
        order_amount: Number(finalSecureTotal),
        order_currency: 'INR',
