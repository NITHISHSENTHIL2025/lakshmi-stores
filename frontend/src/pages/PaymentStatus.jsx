      ...
      <div className="bg-white p-8 md:p-12 rounded-[2rem] shadow-xl border border-gray-100 max-w-md w-full text-center animate-fadeIn">
        ...
        {status === 'failed' && (
          <div className="space-y-4">
            ...
            <p className="text-gray-500 font-bold mb-6">Something went wrong with the transaction. If money was deducted, it will be refunded in 5–7 business days.</p>
            <button
              onClick={() => navigate('/')}
              className="w-full bg-gray-900 hover:bg-black text-white py-4 rounded-xl font-black text-lg transition cursor-pointer"
            >
              Return to Store
            </button>
          </div>
